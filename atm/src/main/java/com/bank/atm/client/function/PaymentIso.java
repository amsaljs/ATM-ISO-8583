...
public class PaymentIso {
    ...
    public String buildIsoMessageInquiry(String rekening, String pin, String virtualAccount, int amount, String server, int port){
        try {
    ...
    public String buildIsoMessagePayment(String rekening, String pin, String virtualAccount, int amount, String server, int port){
        try {
            // Load package from resources directory.
            is = getClass().getResourceAsStream("/fields.xml");
            packager = new GenericPackager(is);
    ...
    public String responseIsoMessageInquiry(String statusCode, String name, int balanced){
        try {
            // Load package from resources directory.
            is = getClass().getResourceAsStream("/fields.xml");
            packager = new GenericPackager(is);
