...
public class BuildIso {
    ...
    public String buildIsoMessage(String rekening, String bankCode, String virtualAccount, int amount){
        try {
    ...
    public String responseIsoMessage(String accountNumber, String forwardingAccount, String statusCode, String name, String bankCode, int balanced){
        try {
            // Load package from resources directory.
            is = getClass().getResourceAsStream("/fields.xml");
            packager = new GenericPackager(is);
